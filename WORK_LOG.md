...
| 应用闪退 | 🔄 修复中 | v1.1.4 修复 ffpyplayer 依赖 |
| 播放不了视频 | 🔄 修复中 | v1.1.4 添加外部播放器备选 |

---

## 修复记录

### 2026-05-31 v1.1.4 修复

**问题**: buildozer.spec 缺少 ffpyplayer 依赖

**修复内容**:
1. 更新 `buildozer.spec`:
   - 添加 `ffpyplayer` 到 requirements
   - 添加 `setuptools` 依赖
   - 添加存储权限
